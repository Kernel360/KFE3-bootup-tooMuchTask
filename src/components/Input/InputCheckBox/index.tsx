...
import { CheckboxInput, CheckWrapper, IconWrapper, Label } from './style';
...
export const InputCheckBox = ({ id, label, onChange, hiddenlabel }: InputCheckProps) => {
  ...
  return (
    <CheckWrapper>
      <Label htmlFor={id.toString()}>
        <CheckboxInput type='checkbox' id={id.toString()} name={label} onChange={onChange} />
